...
const WORSHIP_HOLIDAY_MOMENTS = [
  ...
  { size: "md:col-span-4 md:row-span-1", label: "Audience", src: "/images/choir2.jpg" },
  { size: "md:col-span-3 md:row-span-1", label: "Sanctuary", src: "/images/graduates7.jpg" },
  { size: "md:col-span-2 md:row-span-1", label: "Post-Service", src: "/images/mission8.jpg" },
  { size: "md:col-span-3 md:row-span-1", label: "Group Photo", src: "/images/2.jpg" },
  { size: "md:col-span-2 md:row-span-2", label: "Action Call", src: "/images/graduates1.jpg" },
  ...
  { size: "md:col-span-2 md:row-span-1", label: "Blessing", src: "/images/choir.jpg" },
  { size: "md:col-span-3 md:row-span-1", label: "Benediction", src: "/images/choir2.jpg" },
];
